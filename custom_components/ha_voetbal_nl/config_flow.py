...
class HaVoetbalNlOptionsFlow(OptionsFlowWithReload):
    ...
    def _parse_schedule_lines(raw, *, training=False):
        ...
        # A reminder only makes sense when a poll exists.
        ...
        # Poll must occur before all reminders chronologically.
